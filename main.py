...
def send_welcome(message):
    bot.send_message(message.chat.id, "Добро пожаловать в МедБот.\n\nЯ MVP-приложение которое поможет тебе обучиться СЛР\n\nДавай проверим твое знание в медицине!\nЯ опишу ситуацию в которой мог оказаться кто угодно и дам вам 4 выбора ответа где будет только 1 верный.\nОтветив верно, я опишу следующую ситуацию где будет так же 4 варианта ответа. Если же вы ошибетесь мы начнем игру с начала =)\n\nНачнем? Напиши /game ")
